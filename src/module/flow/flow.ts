  ...
  export const useAppwfConfig = create((set, get) =>({
      ...
      designList:[],
      form: {},
      addNodeMap:async (data: any)=> set((prev:any) =>({ nodeMap: prev.nodeMap.set(data.nodeId, data.node)})),
  ...
  export default {
    APPROVAL_PROPS, CC_PROPS, DELAY_PROPS, CONDITION_PROPS, CONDITION_CONDITIONS, ROOT_PROPS, TRIGGER_PROPS, getConditionKeys, setFormFields, getFormFields, getResource, setScale, getScale, scale, useAppwfConfig
  }
