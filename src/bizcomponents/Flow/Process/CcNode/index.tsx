...
const CcNode: React.FC<CcNodeProps> = (props:CcNodeProps) => {
  ...
  return (
    <Node   title={props.config.name}  showError={false} content={content} errorInfo="错误信息" placeholder="请设置抄送对象" headerBgc="#3296fa" headerIcon="el-icon-s-promotion" onInsertNode={props.onInsertNode} onDelNode={props.onDelNode}   onSelected={props.onSelected}/>
  );
};
