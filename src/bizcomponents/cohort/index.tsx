...
const CreateCohort: React.FC<CohortServiceType>=({
service,
getTableList
}) => {
  console.log(service)
  ...
  return (
    ...
    <div>
      <Button type="link" onClick={showModal}>
        ...
        <Form {...layout} name="nest-messages" labelAlign='left' labelCol={{ span: 7 } }
          wrapperCol={{ span: 20 }}
          layout="horizontal" validateMessages={validateMessages} form= {form}>
          <Form.Item name={['cohort', 'name']} label="群组名称" rules={[
            { //[^\u4E00-\u9FA5]
              pattern: /^[\u4e00-\u9fa5]{2,6}$/,
          ...
          <Form.Item name={['cohort', 'code']} label="群组编号" rules={[
            { //[^\u4E00-\u9FA5]
              pattern: /^[a-zA-Z]+$/,
              message: '群组编号为英文字符组成',
              validateTrigger: 'onBlur'
          ...
          <Form.Item name={['cohort', 'remark']} label="群组简介" rules={[
