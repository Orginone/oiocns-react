    ...
    <Comment
      content={
        <div >
          ...
          <a className={cls.textInner}>共28条回复 <RightOutlined style={{fontSize:'12px'}} /></a>
        </div>
      }
    >
      {children}
...
const AvatarComment: React.FC<{ children?: React.ReactNode }> = ({ children }) => (
  <Comment
    ...
    avatar={<Avatar src="https://randomuser.me/api/portraits/women/1.jpg" alt="杭电应用" />}
    content={
      <span>这是评论这是评论哈哈哈真好啊，评论评论</span>
    }
    datetime={<div style={{ display: 'flex', justifyContent: 'space-between'}}>
...
const commentList = [{title:"全部评论",commentNum:11},{title:"公开评论",commentNum:11},{title:"未读评论",commentNum:11}]
