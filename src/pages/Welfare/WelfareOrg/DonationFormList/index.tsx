...
import { donationformListColumns } from '@/pages/Welfare/config/columns';
 ...
 * @returns
 */
const DonationFormList: React.FC<any> = () => {
    ...
    <div className={cls[`content-box`]}>
      <div className={cls['pages-wrap']}>
        {!openForm && (
          <PageCard
            title={
              <div style={{ fontSize: '16px', fontWeight: 'bold' }}>公益捐赠审批单</div>
            }
            bordered={false}
            tabList={TitleItems}
            ...
            <div className={cls['page-content-table']} ref={parentRef}>
              <CardOrTable<any>
                ...
                columns={donationformListColumns}
                showChangeBtn={true}
                rowSelection={{
