 ...
 */
 class CohortController {
  ...
  public get getMyCohort():Cohort[]{
    let data = this._cohorts.filter((obj) => this.workSpace.target.id == obj.target.belongId);
 ...
 * @returns 
 */
   public async createCohort (obj:Person|Company,name:string,code:string,remark:string):Promise<any>{
  ...
  * @returns 
  */
 public async searchCohort (obj:Person|Company,name:string):Promise<model.ResultType<any>>{
...
/**
  ...
  * @returns 
  */
 public async searchPerson (obj:Person|Company,name:string):Promise<model.ResultType<any>>{
 ...
 * @returns 
 */
public async joinCohort (obj:Person|Company,destId:string):Promise<model.ResultType<any>>{
 ...
 * @returns 
 */
 public async pullCohort (obj:Cohort,PersonId:[string]):Promise<model.ResultType<any>>{
 ...
 * @returns 
 */
 public async deleteCohort (obj:Person|Company,id:string):Promise<model.ResultType<any>>{
