...
const CodeRepository = ({ finished, args }) => {
  ...
  const datas = async ()=>{
    const res = await axios.post('/warehouse/repos',{Code: "445654954863104000"});
    console.log(res);

    const results = await axios.get('/warehouse/llh/repoName2.git');
                  ...
                  <div className="content_edit_style">
                    ...
                    <Tabs defaultActiveKey="content_edit" type={'card'} tabBarGutter={0}>
                      <Tabs.TabPane tab="内容编辑" key="content_edit">
                        ...
                        <Button type="primary" style={{background: '#21ba45',border: '1px solid #21ba45'}}>创建工单</Button>
