...
<<<<<<< HEAD
      icon: <TeamIcon type={"set"} tabbar={true} selected={location.hash.startsWith('#' + '/setting')}  share={orgCtrl.user.share} size={28} title="设置" />,
=======
>>>>>>> 00f13a06ae211be4640b29628d7d55bc50ef0795
      count: 0,
      icon: 'setting',
      fath: '/setting',
      onClick: () => {
